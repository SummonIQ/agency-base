 ...
 */
function mapCompanySize(apolloSize?: string): LeadIntelligenceCompanySize | null {
  ...
  const sizeMap: Record<string, LeadIntelligenceCompanySize> = {
    ...
    "1001+": LeadIntelligenceCompanySize.LARGE_ENTERPRISE,
  };

  return sizeMap[apolloSize] || LeadIntelligenceCompanySize.MID_MARKET;
}
