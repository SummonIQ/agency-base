...
export async function optimizeResume({
  ...
  2. Enhancing formatting while maintaining Markdown structure.
  ...
  6. You are also an expert in correcting and improving Markdown formatting.
     - Check that the markdown is formatted correctly.
     ...
     - Ensure that the markdown is formatted correctly.
  ...
  9. Enhance formatting while preserving valid Markdown structure.
  10. Optimize content with ATS-friendly keywords that are specific to the role.
  11. Use action-oriented language.
  12. Correct any formatting errors in the Markdown.
  13. I want all data to be structured following the schema below exactly.
  ...
  \`\`\`{
    ...
    "changelog": ["string"], // changelog of the resume - e.g  Standardized verb tenses, Corrected spelling errors, Added missing keywords: SEO, Agile, Reformatted education section for ATS
    "confidence_metrics": {
  ...
  const { object } = await generateObject({
    ...
    schema: z.object({
      ...
      changelog: z.array(z.string()), // changelog of the resume - e.g  Standardized verb tenses, Corrected spelling errors, Added missing keywords: SEO, Agile, Reformatted education section for ATS
