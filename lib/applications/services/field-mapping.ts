...
export const PLATFORM_FIELD_MAPPINGS: Record<JobBoard, PlatformFieldMapping> = {
  [JobBoard.LINKEDIN]: {
    platform: JobBoard.LINKEDIN,
    fields: [
      ...UNIVERSAL_FIELDS,
      {
        id: 'linkedinProfile',
  ...
  [JobBoard.ZIPRECRUITER]: {
    platform: JobBoard.ZIPRECRUITER,
    fields: [
  ...
  [JobBoard.GOOGLE]: {
    platform: JobBoard.GOOGLE,
    fields: UNIVERSAL_FIELDS,
    requiredFields: ['firstName', 'lastName', 'email'],
  },
  [JobBoard.MONSTER]: {
    platform: JobBoard.MONSTER,
    fields: UNIVERSAL_FIELDS,
    requiredFields: ['firstName', 'lastName', 'email'],
  },
  [JobBoard.DICE]: {
    platform: JobBoard.DICE,
    fields: UNIVERSAL_FIELDS,
    requiredFields: ['firstName', 'lastName', 'email'],
  },
  [JobBoard.CAREER_BUILDER]: {
    platform: JobBoard.CAREER_BUILDER,
    fields: UNIVERSAL_FIELDS,
    requiredFields: ['firstName', 'lastName', 'email'],
  },
  [JobBoard.FLEXJOBS]: {
    platform: JobBoard.FLEXJOBS,
    fields: UNIVERSAL_FIELDS,
    requiredFields: ['firstName', 'lastName', 'email'],
  },
  [JobBoard.REMOTE_OK]: {
    platform: JobBoard.REMOTE_OK,
    fields: UNIVERSAL_FIELDS,
    requiredFields: ['firstName', 'lastName', 'email'],
  },
  [JobBoard.WE_WORK_REMOTELY]: {
    platform: JobBoard.WE_WORK_REMOTELY,
    fields: UNIVERSAL_FIELDS,
    requiredFields: ['firstName', 'lastName', 'email'],
  },
  [JobBoard.OTHER]: {
...
export class FieldMappingService {
   ...
   */
  static getFieldMapping(platform: JobBoard): PlatformFieldMapping {
    return PLATFORM_FIELD_MAPPINGS[platform] || PLATFORM_FIELD_MAPPINGS[JobBoard.OTHER];
  }

  /**
   * Get all fields for a platform
   */
  static getFields(platform: JobBoard): FieldDefinition[] {
   ...
   */
  static getRequiredFields(platform: JobBoard): string[] {
   ...
   */
  static getFieldsByCategory(platform: JobBoard): Record<string, FieldDefinition[]> {
  ...
  static transformUserData(
    ...
    switch (platform) {
      ...
      case JobBoard.ANGELLIST:
      case JobBoard.WELLFOUND:
   ...
   */
  static compareFieldMappings(platform1: JobBoard, platform2: JobBoard): {
    commonFields: string[];
