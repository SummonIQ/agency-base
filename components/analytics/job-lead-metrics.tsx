...
const STATUS_COLORS = {
  ...
  [JobLeadStatus.INTERVIEWED]: '#8b5cf6',
  [JobLeadStatus.OFFER_MADE]: '#10b981',
  [JobLeadStatus.OFFER_ACCEPTED]: '#059669',
  [JobLeadStatus.OFFER_REJECTED]: '#ef4444',
  [JobLeadStatus.REJECTED]: '#dc2626',
  [JobLeadStatus.DISMISSED]: '#6b7280',
};
...
const STATUS_LABELS = {
  ...
  [JobLeadStatus.INTERVIEWED]: 'Interviewed',
  [JobLeadStatus.OFFER_MADE]: 'Offer Made',
  [JobLeadStatus.OFFER_ACCEPTED]: 'Offer Accepted',
  [JobLeadStatus.OFFER_REJECTED]: 'Offer Rejected',
  [JobLeadStatus.REJECTED]: 'Rejected',
  [JobLeadStatus.DISMISSED]: 'Dismissed',
};
