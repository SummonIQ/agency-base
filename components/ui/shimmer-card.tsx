    ...
    >
      <div className="absolute -inset-12 flex scale-x-110 scale-y-50 items-center [container-type:inline-size]">
        <div
          ...
          // className="absolute size-[100cqw] animate-spin bg-[conic-gradient(from_0_at_50%_50%,oklch(var(--primary)_/_0.5)_0deg,transparent_60deg,transparent_300deg,oklch(var(--primary)_/_0.5)_360deg)] opacity-60 transition duration-300 [animation-duration:3s] dark:bg-[conic-gradient(from_0_at_50%_50%,oklch(var(--primary-dark)_/_0.5)_0deg,transparent_60deg,transparent_300deg,oklch(var(--primary-dark)_/_0.5)_360deg)]"
