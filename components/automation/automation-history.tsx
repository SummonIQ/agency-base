...
export function AutomationHistory() {
  ...
  const filteredApplications = applications.filter(app => {
    ...
    const matchesJobBoard = filter.jobBoard === 'all' || app.jobBoard === filter.jobBoard;
    ...
    return matchesStatus && matchesJobBoard && matchesSearch;
  });
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row gap-2">
        ...
        <Select
          value={filter.jobBoard}
          onValueChange={(jobBoard) => setFilter(prev => ({ ...prev, jobBoard }))}
        >
          <SelectTrigger className="sm:w-[140px]">
            <SelectValue />
          </SelectTrigger>
