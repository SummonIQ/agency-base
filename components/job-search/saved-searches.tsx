...
export function SavedSearches({
  ...
  const handleRunSearch = (searchId: string) => {
    ...
    toast({
      ...
      description: 'Your saved search is now running. Results will appear shortly.',
    });
  };
                ...
                <div className="flex items-start justify-between">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      <DropdownMenuItem onClick={() => handleRunSearch(search.id)}>
                ...
                {search.lastRun && (
                  <div className="space-y-1 text-sm">
                    <div className="flex items-center justify-between">
                      ...
                      <span>
                        {formatDistanceToNow(search.lastRun, { addSuffix: true })}
                      </span>
                    </div>
                    {search.newJobsCount !== undefined && search.newJobsCount > 0 && (
                      <div className="flex items-center justify-between">
      ...
      <Dialog open={!!deleteConfirmId} onOpenChange={() => setDeleteConfirmId(null)}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete this saved search? This action cannot
              be undone.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
