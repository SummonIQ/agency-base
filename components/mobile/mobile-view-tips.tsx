...
const MOBILE_TIPS = [
  ...
  },
  {
    ...
    description: "Stay updated on project updates and client communications even when you're away from your computer.",
    icon: <Smartphone className="h-5 w-5" />,
  },
  {
    id: 3,
    title: "Save Jobs for Later",
    description: "Use bookmarks to save important client information and project details for later.",
    icon: <Lightbulb className="h-5 w-5" />,
  },
  {
    id: 4,
    title: "Use Progressive Web App",
    description: "Add AgencyBase to your home screen for a more app-like experience on mobile.",
    icon: <Smartphone className="h-5 w-5" />,
  },
  {
    id: 5,
    title: "Quick Application Mode",
    description: "Enable quick actions in settings to streamline client management on mobile.",
        ...
        {!isPWAInstalled() && (
          <div className="mt-6 border border-dashed rounded-md p-4">
            ...
            <p className="text-xs text-muted-foreground mt-1 mb-3">
              Add AgencyBase to your home screen for a better mobile experience.
            </p>
