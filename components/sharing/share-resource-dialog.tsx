...
export function ShareResourceDialog({
  ...
  const [accessLevel, setAccessLevel] = useState<ShareAccessLevel>(ShareAccessLevel.VIEW);
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>Share {resourceType === ShareableResourceType.JOB_LEAD ? 'Job Lead' : 'Resume'}</DialogTitle>
          <DialogDescription>
            {shareUrl ? 'Share this link with others' : `Share "${resourceName}" with others`}
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value={ShareAccessLevel.VIEW}>View only</SelectItem>
                  <SelectItem value={ShareAccessLevel.COMMENT}>Allow comments</SelectItem>
                  <SelectItem value={ShareAccessLevel.EDIT}>Allow editing</SelectItem>
                </SelectContent>
              </Select>
            </div>
          ...
          <div className="py-6">
            ...
            <div className="mt-4 flex justify-center">
              <div className="bg-gray-100 p-3 rounded-md inline-flex items-center text-sm text-gray-600">
                ...
                Anyone with this link can access this {resourceType === ShareableResourceType.JOB_LEAD ? 'job lead' : 'resume'}
              </div>
            </div>
          </div>
        )}
