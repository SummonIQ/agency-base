...
import { type JobSearch, Prisma } from '@prisma/client';
...
const columns: Array<ReportColumn<JobSearch>> = [
  // {
  //   accessorKey: "id",
  //   enableHiding: false,
  // },
  ...
  {
    cellFn: ({ id, status }) => {
      return <JobSearchStatusBadge status={status} />;
    },
    header: 'Status',
    key: 'status',
    sortable: true,
