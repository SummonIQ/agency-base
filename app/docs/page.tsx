// our new Report component (the one without card logic)
// the file with our updated column definitions
import {
...
export default function TestPage() {
  ...
  return (
    <Page>
      <PageHeader>
        <PageSummary>
          <PageTitle>Dev Docs</PageTitle>
          <PageDescription>
            Testing stuff out in real time baby.
          </PageDescription>
        </PageSummary>
        <PageActions>
      ...
      <PageContent className="space-y-12">
        <Tabs defaultValue="job-lead-progress">
          <TabsList>
            <TabsTrigger value="badges">Badges</TabsTrigger>
            <TabsTrigger value="job-lead-progress">Progress</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="job-lead-progress">
