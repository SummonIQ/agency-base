...
export const metadata: Metadata = {
  ...
  description: 'Configure automation safety controls, rate limits, and notification preferences.',
};
...
export default function AutomationSettingsPage() {
  return (
    <Page>
      <PageHeader>
        <PageSummary>
          <PageTitle>Automation Settings</PageTitle>
          <PageDescription>
            Configure safety controls, rate limits, and notification preferences for your application automation.
          </PageDescription>
        </PageSummary>
      </PageHeader>
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Configure safety measures to prevent unwanted applications and ensure responsible automation.
            </p>
          ...
          <section>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Set limits on how many applications can be submitted per hour and per day.
            </p>
          ...
          <section>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Configure intelligent scheduling to optimize application submission timing.
            </p>
          ...
          <section>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Configure how and when you want to be notified about automation activity.
            </p>
