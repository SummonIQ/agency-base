...
import { 
  AccessibleChart,
  ACCESSIBLE_COLOR_SCHEMES
} from '@/components/charts/interactive/accessible';
...
export default function ChartsShowcasePage() {
  ...
  const metricsUpdateSource = async () => {
    return [
      { id: '1', label: 'Total Applications', value: Math.floor(Math.random() * 200) + 50, unit: 'apps', trend: 'up' as const },
      { id: '2', label: 'Response Rate', value: Math.floor(Math.random() * 40) + 20, unit: '%', trend: 'stable' as const },
      { id: '3', label: 'Interview Rate', value: Math.floor(Math.random() * 20) + 10, unit: '%', trend: 'up' as const },
      { id: '4', label: 'Offer Rate', value: Math.floor(Math.random() * 10) + 2, unit: '%', trend: 'down' as const },
    ];
  };
  ...
  return (
    <div className="container mx-auto p-6 space-y-8">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold">Interactive Charts Showcase</h1>
          <p className="text-muted-foreground mt-2">
            Comprehensive collection of chart components with real-time updates, responsive design, and accessibility features
          </p>
        </div>
      ...
      <Tabs defaultValue="basic" className="space-y-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            >
              <InteractiveLineChart
                data={timeSeriesData}
                lines={[
                  { key: 'applications', name: 'Applications', color: COLOR_SCHEMES[colorScheme][0] },
                  { key: 'responses', name: 'Responses', color: COLOR_SCHEMES[colorScheme][1] },
                  { key: 'interviews', name: 'Interviews', color: COLOR_SCHEMES[colorScheme][2] },
                ]}
                xAxisKey="date"
                height={300}
                showBrush={true}
            ...
            >
              <InteractiveRadarChart
                ...
                radars={[
                  ...
                  { key: 'average', name: 'Average Candidate', fillOpacity: 0.1 },
                ]}
                angleKey="skill"
                height={300}
                colors={COLOR_SCHEMES[colorScheme]}
            ...
            >
              <InteractiveBarChart
                ...
                bars={[
                  ...
                  { key: 'interviews', name: 'Interviews', stackId: 'stack' },
                ]}
                xAxisKey="category"
                height={300}
                stacked={true}
        ...
        <TabsContent value="realtime" className="space-y-6">
          ...
          <RealtimeMetrics
            ...
            metrics={[
              { id: '1', label: 'Active Applications', value: 42, unit: 'apps', trend: 'up' },
              { id: '2', label: 'Today\'s Responses', value: 8, unit: 'responses', trend: 'stable' },
              { id: '3', label: 'Pending Reviews', value: 15, unit: 'reviews', trend: 'down' },
              { id: '4', label: 'Success Rate', value: 12.5, unit: '%', trend: 'up' },
            ]}
            updateInterval={3000}
        ...
        <TabsContent value="responsive" className="space-y-6">
          <div className="mb-4 p-4 bg-muted rounded-lg">
            <p className="text-sm text-muted-foreground">
              These charts automatically adapt to different screen sizes. Try resizing your browser window to see the responsive behavior.
            </p>
          </div>
          ...
          <div className="lg:hidden">
            <h3 className="text-lg font-semibold mb-4">Swipeable Chart Carousel (Mobile Only)</h3>
            <ChartCarousel
              charts={[
      ...
      <div className="mt-12 p-6 bg-muted rounded-lg">
        <h2 className="text-xl font-semibold mb-4">Chart Component Features</h2>
