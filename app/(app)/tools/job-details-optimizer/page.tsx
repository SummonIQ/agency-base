...
export const metadata: Metadata = {
  ...
  title: 'Job Details Optimizer | gimmejob',
};
  ...
  return (
    <Page>
      <PageHeader className="border-b border-border/50">
        <PageSummary>
          <PageTitle>Job Details Optimizer</PageTitle>
          <PageDescription>
      ...
      <PageContent className="flex grow flex-col">
        <div className="flex grow flex-col gap-4 lg:flex-row">
          <div className="flex flex-col gap-2 pt-4 lg:w-72">
            <h4 className="text-lg font-semibold">Input</h4>

            <Accordion collapsible defaultValue="resume" type="single">
