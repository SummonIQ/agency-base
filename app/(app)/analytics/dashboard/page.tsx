...
export const metadata: Metadata = {
  title: 'Analytics Dashboard | AgencyBase',
  description: 'Comprehensive analytics for your agency operations',
};

const analyticsCards = [
  {
    title: 'Application Analytics',
    description: 'Track application outcomes, response rates, and conversion metrics',
    icon: BarChart3,
  ...
  },
  {
    ...
    description: 'Track interview success rates and identify areas for improvement',
    icon: Users,
    href: '/analytics',
    tabValue: 'interviews',
    metrics: [
    ...
    <Page>
      <PageHeader>
        <PageSummary>
          ...
          <PageDescription>
            Get comprehensive insights into your job search performance with advanced analytics and data visualization.
          </PageDescription>
        </PageSummary>
      </PageHeader>
              ...
              <Card key={card.title} className="hover:shadow-lg transition-shadow">
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <Link 
                      href={card.href + (card.tabValue ? `?tab=${card.tabValue}` : '')}
                    >
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                ...
                <ul className="space-y-1 text-sm text-green-700 dark:text-green-300">
                  <li>• Your Tuesday applications have 28% higher response rate</li>
              ...
              <div className="p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
                ...
                <ul className="space-y-1 text-sm text-yellow-700 dark:text-yellow-300">
                  ...
                  <li>• Apply within 24 hours of job posting for better results</li>
